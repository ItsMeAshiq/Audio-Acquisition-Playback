	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Acquire &amp; Store" Type="Folder">
			...
			<Item Name="support" Type="Folder">
				<Item Name="typedefs" Type="Folder">
					<Item Name="Audio_Data.ctl" Type="VI" URL="../Acquire &amp; Store/support/typedefs/Audio_Data.ctl"/>
					<Item Name="Record_States.ctl" Type="VI" URL="../Acquire &amp; Store/support/typedefs/Record_States.ctl"/>
				</Item>
				<Item Name="append_audio.vi" Type="VI" URL="../Acquire &amp; Store/support/append_audio.vi"/>
				<Item Name="Build_ACQ_cfg.vi" Type="VI" URL="../Acquire &amp; Store/support/Build_ACQ_cfg.vi"/>
				<Item Name="Build_Plot_Selection-Acquire.vi" Type="VI" URL="../Acquire &amp; Store/support/Build_Plot_Selection-Acquire.vi"/>
				<Item Name="Random_Color.vi" Type="VI" URL="../Acquire &amp; Store/support/Random_Color.vi"/>
				<Item Name="Build_Device_Details.vi" Type="VI" URL="../Acquire &amp; Store/support/Build_Device_Details.vi"/>
			</Item>
			<Item Name="Audio ACQ &amp; Store.vi" Type="VI" URL="../Acquire &amp; Store/Audio ACQ &amp; Store.vi"/>
		</Item>
		<Item Name="Playback" Type="Folder">
			<Item Name="support" Type="Folder">
				<Item Name="typedefs" Type="Folder">
					<Item Name="Playback_States.ctl" Type="VI" URL="../Playback/support/typedefs/Playback_States.ctl"/>
				</Item>
				<Item Name="Get Basic Audio File Info - Copy.vi" Type="VI" URL="../Playback/support/Get Basic Audio File Info - Copy.vi"/>
				<Item Name="Result To Error - Copy.vi" Type="VI" URL="../Playback/support/Result To Error - Copy.vi"/>
				<Item Name="Audio CFG.ctl" Type="VI" URL="../Playback/support/typedefs/Audio CFG.ctl"/>
				<Item Name="Seek Audio.vi" Type="VI" URL="../Playback/support/Seek Audio.vi"/>
				<Item Name="Build_Plot_Selection-Playback.vi" Type="VI" URL="../Playback/support/Build_Plot_Selection-Playback.vi"/>
				<Item Name="Play Audio.vi" Type="VI" URL="../Playback/support/Play Audio.vi"/>
			</Item>
			<Item Name="Audio Playback.vi" Type="VI" URL="../Playback/Audio Playback.vi"/>
		</Item>
		<Item Name="Recordings" Type="Folder" URL="../Recordings">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Demo Video" Type="Folder" URL="../Demo Video">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="g_audio_x86.dll" Type="Document" URL="/&lt;vilib&gt;/Dataflow_G/G-Audio/lib/g_audio_x86.dll"/>
